...
import { $i as OrthographicCamera, Bo as Sphere, Bs as Vector2, Da as RGBAFormat, Eo as SRGBColorSpace, Fr as LinearFilter, Fs as UnsignedIntType, Ht as DataTexture, J as BufferAttribute, Os as Uniform, Sn as FloatType, Vn as HalfFloatType, Vs as Vector3, Xt as DepthTexture, Y as BufferGeometry, Ys as WebGLRenderTarget, ai as Mesh, ct as Color, ds as Texture, fs as TextureLoader, jn as GLSL3, ko as ShaderMaterial, po as RedFormat, ri as Matrix4, tt as CanvasTexture, vo as RepeatWrapping, xi as NearestFilter, xn as Float32BufferAttribute } from "./three.module-2AySgERg.js";
import { D as useLoader, c as applyProps, g as extend, k as useThree, p as createPortal, w as useFrame } from "./react-three-fiber.esm-CcA5OUV3.js";
import { t as require_jsx_runtime } from "./react_jsx-runtime.js";
import { t as easing } from "./maath.esm-DyIBVaPv.js";
...
function Me(e, t) {
	...
	for (let r = 0; r < e.length; r++) {
		...
		if (i instanceof Effect) {
			...
			if (!Oe(i)) {
				let t;
				for (; (t = e[r + 1]) instanceof Effect && !Oe(t);) a.push(t), r++;
			}
...
var Ne = /* @__PURE__ */ (0, import_react.memo)(function({ children: e, camera: t, scene: n, resolutionScale: i, enabled: o = !0, renderPriority: s = 1, autoClear: c = !0, depthBuffer: l, enableNormalPass: u, stencilBuffer: d, multisampling: p = 8, frameBufferType: m = HalfFloatType, ref: h }) {
	let { gl: g, scene: y, camera: b, size: x } = useThree(), S = n || y, C = t || b, [w, T] = (0, import_react.useState)(null);
	(0, import_react.useEffect)(() => {
		Ae.acquire(g, !1);
		let e = new EffectComposer(g, {
			depthBuffer: l,
			stencilBuffer: d,
			multisampling: p,
			frameBufferType: m
		});
		e.addPass(new RenderPass(S, C));
		let t = null, n = null;
		return u && (t = new NormalPass(S, C), t.enabled = !1, e.addPass(t), i !== void 0 && (n = new DepthDownsamplingPass({
	...
	(0, import_react.useLayoutEffect)(() => {
		...
		if (i) {
			let e = i.children.map((e) => e.object).filter((e) => e instanceof Effect || e instanceof Pass);
			r.push(...Me(e, C));
		}
		...
		e,
		C
	]), (0, import_react.useEffect)(() => (je.acquire(g, 0), g.toneMapping = 0, () => {
		je.release(g);
	}), [g]);
...
var K = /* @__PURE__ */ (0, import_react.createContext)(null);
function Pe({ children: e, enabled: t = !0 }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(K.Provider, {
		value: i,
		children: e
	});
}
...
function Ie({ enabled: e = !1, children: t, ...n }) {
	let r = (0, import_react.useRef)(null), i = (0, import_react.use)(K)?.select, a = (0, import_react.useRef)([]);
	...
	}, [i]), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("group", {
		ref: r,
		...n,
		children: t
	});
...
function Y(e, t, n) {
	let r = useThree((e) => e.invalidate), i = (0, import_react.use)(K);
	(0, import_react.useEffect)(() => {
...
function $(e, t) {
	return function({ ref: r, blendFunction: i = t?.blendFunction, opacity: o = t?.opacity, ...s }) {
		...
		if (!c) {
			...
			extend({ [t]: e }), Re.set(e, c = t);
		}
		let l = useThree((e) => e.camera), u = (0, import_react.useMemo)(() => [...t?.args ?? [], ...s.args ?? [{
			...t,
			...s
		}]], [He(s)]);
...
function Ge({ font: e = "arial", characters: t = " .:,'-^=*+?!|0#X%WM@", fontSize: n = 54, cellSize: r = 16, color: i = "#ffffff", invert: a = !1, ref: o }) {
	...
	return X(s), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("primitive", {
		ref: o,
		object: s
	});
}
function Ke({ ref: e, blendFunction: t, worldFocusDistance: n, worldFocusRange: r, focusDistance: i, focusRange: a, focalLength: o, bokehScale: s, resolutionScale: c, resolutionX: l, resolutionY: u, width: d, height: f, target: p, depthTexture: h, ...g }) {
	let { camera: _ } = (0, import_react.use)(G), v = p != null, y = (0, import_react.useMemo)(() => {
		let e = new DepthOfFieldEffect(_, {
			blendFunction: t,
		...
		v && (e.target = new Vector3()), h && e.setDepthTexture(h.texture, h.packing);
		let p = e.maskPass;
		return p.maskFunction = MaskFunction.MULTIPLY_RGB_SET_ALPHA, e;
	}, [
		_,
		t,
		n,
	...
	return X(y), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("primitive", {
		...g,
		object: y,
		ref: e,
		target: p
...
function Je({ target: e = void 0, mouse: n = !1, debug: i = void 0, manual: o = !1, smoothTime: s = .25, ref: c, ...l }) {
	let u = (0, import_react.useRef)(null), f = (0, import_react.useRef)(null), p = (0, import_react.useRef)(null), m = useThree(({ scene: e }) => e), g = useThree(({ pointer: e }) => e), { composer: _, camera: v } = (0, import_react.useContext)(G), [y] = (0, import_react.useState)(() => qe(new DepthPickingPass())), [b] = (0, import_react.useState)(() => qe(new CopyPass()));
	...
	let [x] = (0, import_react.useState)(() => new Vector3(0, 0, 0)), [S] = (0, import_react.useState)(() => new Vector3(0, 0, 0)), C = (0, import_react.useCallback)(async (e, t) => (S.x = e, S.y = t, S.z = await y.readDepth(S), S.z = S.z * 2 - 1, 1 - S.z > 1e-7 && S.unproject(v)), [
		S,
		y,
		v
	]), w = (0, import_react.useCallback)(async (t, r = !0) => {
		if (e) x.set(...e);
		else {
			let { x: e, y: t } = n ? g : {
				x: 0,
		...
		r && u.current?.target && (s > 0 && t > 0 ? easing.damp3(u.current.target, x, s, t) : u.current.target.copy(x));
	}, [
		e,
		x,
		n,
	...
	return (0, import_react.useImperativeHandle)(c, () => T, [T]), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [i ? createPortal(/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("mesh", {
		ref: f,
	...
	})] }), m) : null, /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Ke, {
		ref: u,
		...l,
		target: x
	})] });
}
var Ye = /* @__PURE__ */ $(BloomEffect, { blendFunction: 0 });
var Xe = /* @__PURE__ */ $(BrightnessContrastEffect);
function Ze({ ref: e, ...t }) {
	let n = Z(t, "offset"), r = (0, import_react.useMemo)(() => new ChromaticAberrationEffect({
		...t,
		offset: n
	}), [n, t]);
	return X(r), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("primitive", {
		object: r,
		ref: e
	});
}
function Qe({ blendFunction: e = 23, ref: t }) {
	...
	return X(n), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("primitive", {
		object: n,
		ref: t
	});
}
var $e = /* @__PURE__ */ $(ColorDepthEffect);
var et = /* @__PURE__ */ $(DepthEffect);
var tt = /* @__PURE__ */ $(DotScreenEffect);
var nt = /* @__PURE__ */ $(FXAAEffect);
function rt({ active: e = !0, ref: t, ...n }) {
	let r = useThree((e) => e.invalidate), i = Z(n, "delay"), o = Z(n, "duration"), s = Z(n, "strength"), c = Z(n, "chromaticAberrationOffset"), l = (0, import_react.useMemo)(() => new GlitchEffect({
		...n,
		delay: i,
		duration: o,
		strength: s,
	...
	return (0, import_react.useLayoutEffect)(() => {
		...
		r,
		n.mode
	]), X(l), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("primitive", {
		ref: t,
		object: l
	});
}
function it({ ref: e, ...t }) {
	...
	return (0, import_react.useLayoutEffect)(() => void (r.lightSource = J(t.sun)), [r, t.sun]), X(r), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("primitive", {
		ref: e,
		object: r
	});
}
function at({ size: e, ref: t, ...n }) {
	let r = useThree((e) => e.invalidate), i = (0, import_react.useMemo)(() => new GridEffect(n), [n]);
	return (0, import_react.useLayoutEffect)(() => {
		...
		e,
		r
	]), X(i), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("primitive", {
		ref: t,
		object: i
	});
}
var ot = /* @__PURE__ */ $(HueSaturationEffect);
...
var lt = /* @__PURE__ */ $(ct);
var ut = ({ smoothTime: e = .07, blendFunction: t = 23, enabled: n = !0, glareSize: i = .2, lensPosition: o = new Vector3(-25, 6, -60), screenRes: s = new Vector2(0, 0), starPoints: c = 6, flareSize: l = .01, flareSpeed: u = .01, flareShape: d = .01, animated: f = !0, anamorphic: p = !1, colorGain: m = new Color(20, 20, 20), lensDirtTexture: h = null, haloScale: g = .5, secondaryGhosts: _ = !0, aditionalStreaks: v = !0, ghostScale: y = 0, opacity: b = 1, starBurst: x = !1 }) => {
	let S = useThree(({ viewport: e }) => e), C = useThree(({ raycaster: e }) => e), { scene: w, camera: T } = (0, import_react.useContext)(G), [E] = (0, import_react.useState)(() => new Vector2()), [D] = (0, import_react.useState)(() => new Vector3()), O = (0, import_react.useRef)(null);
	return useFrame((t, n) => {
		if (!O?.current) return;
		...
		s && (s.userData?.lensflare === "no-occlusion" ? a = 0 : s instanceof Mesh && (s.material.uniforms?._transmission?.value > .2 || s.material._transmission && s.material._transmission > .2 ? a = .2 : s.material.transparent && (a = s.material.opacity))), easing.damp(i, "value", a, e, n);
	}), (0, import_react.useEffect)(() => {
		if (!O?.current) return;
		let e = O.current.uniforms.get("screenRes");
		e && (e.value.x = S.width, e.value.y = S.height);
	}, [S]), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(lt, {
		ref: O,
		blendFunction: t,
		enabled: n,
		glareSize: i,
...
function dt({ lut: e, tetrahedralInterpolation: t, ref: n, ...r }) {
	let i = (0, import_react.useMemo)(() => new LUT3DEffect(e, r), [e, r]), o = useThree((e) => e.invalidate);
	return (0, import_react.useLayoutEffect)(() => {
...
var ft = /* @__PURE__ */ $(NoiseEffect, { blendFunction: 5 });
function pt({ selection: e = q, selectionLayer: t = 10, blendFunction: n, patternTexture: r, patternScale: i, edgeStrength: a, pulseSpeed: o, visibleEdgeColor: s, hiddenEdgeColor: c, multisampling: l, resolutionScale: u, resolutionX: d, resolutionY: f, width: p, height: m, kernelSize: h, blur: g, xRay: _, ref: v }) {
	...
	return Y(x, e, t), X(x), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("primitive", {
		ref: v,
		object: x
	});
}
	...
	constructor({ rampType: e = 0, rampStart: t = [.5, .5], rampEnd: n = [1, 1], startColor: r = [
		...
		super("RampEffect", ht.fragmentShader, {
			...
			uniforms: /* @__PURE__ */ new Map([
				...
				["rampInvert", new Uniform(c)]
			])
		});
	}
};
var vt = /* @__PURE__ */ $(_t);
var yt = /* @__PURE__ */ $(ScanlineEffect, {
	blendFunction: 24,
	density: 1.25
});
...
function St({ selection: e = q, selectionLayer: t = 10, lights: n = q, inverted: r = !1, ignoreBackground: i = !1, luminanceThreshold: o, luminanceSmoothing: s, mipmapBlur: c, intensity: l, radius: u, levels: d, kernelSize: f, resolutionScale: p, width: m, height: h, resolutionX: g, resolutionY: _, ref: v }) {
	let { scene: y, camera: b } = (0, import_react.use)(G), x = useThree((e) => e.invalidate), S = (0, import_react.useMemo)(() => {
		let e = new SelectiveBloomEffect(y, b, {
			blendFunction: 0,
	...
	return Y(S, e, t), (0, import_react.useEffect)(() => {
		...
		n,
		t
	]), X(S), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("primitive", {
		ref: v,
		object: S
	});
}
var Ct = /* @__PURE__ */ $(SepiaEffect);
var wt = /* @__PURE__ */ $(ShockWaveEffect);
var Tt = /* @__PURE__ */ $(SMAAEffect);
function Et({ ref: e, ...t }) {
	...
	return X(o), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("primitive", {
		ref: e,
		object: o
	});
}
...
var Ot = /* @__PURE__ */ $(TiltShiftEffect, { blendFunction: 0 });
...
var jt = /* @__PURE__ */ $(At, { blendFunction: 23 });
var Mt = /* @__PURE__ */ $(ToneMappingEffect);
var Nt = /* @__PURE__ */ $(VignetteEffect);
...
var It = /* @__PURE__ */ $(Ft, { blendFunction: 23 });
function Lt({ halfRes: t, screenSpaceRadius: n, quality: r, depthAwareUpsampling: i = !0, aoRadius: o = 5, aoSamples: s = 16, denoiseSamples: c = 4, denoiseRadius: l = 12, distanceFalloff: u = 1, intensity: d = 1, color: f, renderMode: p = 0, ref: m }) {
	...
	}, [_, r]), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("primitive", {
		ref: m,
		object: _
	});
}
